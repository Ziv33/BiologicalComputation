...
Each basic regulation condition corresponds to the necessary conditions of 
monotonic regulation conditions - Given IN, the maximum number of inhibitors in the system, 
and AC, the maximum number of activators in the system, if for a pair (# inhibitors, # activators) = (n_1, m_1),
their target is 1, then for every [n_2 = n_1] [m_1 < m_2 <= AC] the pairs (n_2, m_2) have target = 1,
and also for every [n_2 < n_1] & [m_2 >= m_1] the pairs (n_2, m_2) have target = 1.
...
applying monotonicity-preserving operations for boolean functions - AND, OR,
